...
\begin{abstract}
We construct co-voting networks for every U.S.\ House Congress from the 100th (1987) through the 118th (2025) and track their spectral properties over time. The Fiedler value rises from 0.534 to a peak of 0.805 in the post-9/11 107th Congress, surges again to 0.737 in the 111th, then collapses to 0.032 by the 118th. The post-2010 collapse is robust across vote subsets, null model comparisons, and weighted Laplacian specifications. A Bridge Legislator Index (BLI) quantifying each member's contribution to algebraic connectivity is conceptually distinct from ideological scaling but empirically confounded with centrism in this setting: bridge legislators depart at elevated rates ($p < 10^{-7}$), though this vulnerability reflects their moderate positioning rather than network role per se. Their departure is nonetheless what physically disconnects the graph. Counterfactual perturbation experiments suggest that roughly 35 bridge legislators account for most of the structural difference between the connected 103rd Congress and the disconnected 118th. The structural scaffolding of bipartisan cooperation has lost its capacity for self-repair.
\end{abstract}
