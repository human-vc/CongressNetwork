...
Figure~\ref{fig:freshman_cohorts} compares the distribution of cross-party agreement rates for incoming freshmen in the 104th and 112th Congresses. The Contract class had a mean cross-party agreement rate of 0.399, nearly identical to incumbents (0.402). Its distribution has a fat right tail: 41\% of Contract freshmen exceeded a cross-party agreement rate of 0.40, and 8\% exceeded 0.45. Members like Tom Campbell (R-CA, 0.488), Michael Doyle (D-PA, 0.486), and Frank LoBiondo (R-NJ, 0.449) cooperated across the aisle at rates comparable to the pre-existing moderate bloc. The Contract wave shifted the chamber rightward while still injecting members capable of forming cross-party bridges.

The Tea Party class was different. Its mean cross-party agreement rate was 0.318 (medians: 0.296 vs.\ 0.390), and its distribution is concentrated below 0.35, with only 9\% exceeding 0.40. A two-sample Kolmogorov-Smirnov test rejects the null of equal distributions ($D = 0.83$, $p < 10^{-34}$). The Tea Party wave did not merely shift the chamber rightward; it injected a cohort that refused to cooperate across party lines at all. Critically, this was not just an artifact of the chamber's overall polarization: Tea Party freshmen cooperated less than their own incumbent co-partisans (freshmen mean 0.318 vs.\ incumbent mean 0.306, with freshmen concentrated at the low end rather than distributed across the range).

This distributional difference provides a mechanism for the recovery asymmetry. The Contract wave, despite its ideological intensity, preserved the raw material for cross-party cooperation. When the initial shock dissipated, moderate freshmen were available to form new bridges, enabling the network to recover and even overshoot (ratio 1.93). The Tea Party wave eliminated that raw material. No amount of post-shock adjustment could rebuild bridges from a cohort that never formed them.
